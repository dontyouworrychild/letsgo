# Generated by Django 3.2.16 on 2023-06-23 01:24
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friends', models.ManyToManyField(blank=True, null=True,
                 related_name='_users_user_friends_+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[
                 ('pending', 'Pending'), ('accepted', 'Accepted'), ('declined', 'Declined')], default='pending', max_length=20)),
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='friendrequest_received', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='friendrequest_sent', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
